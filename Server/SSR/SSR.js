...
const homeStyles = `<link rel="stylesheet" type="text/css" href="./Css/HomeStyle.css">`;
const chatroomStyles = `<link rel="stylesheet" type="text/css" href="./Css/ChatroomStyle.css">`;
const smilePostsStyles = `<link rel="stylesheet" type="text/css" href="./Css/SmilePostsStyle.css">`;
const loginStyles = `<link rel="stylesheet" type="text/css" href="./Css/LoginStyle.css">`;
const myPageStyles = `<link rel="stylesheet" type="text/css" href="./Css/MyPageStyle.css">`;
